...
base_dir = Path("models/classification/efficientnet_v2_s")
...
onnx_input = resize(onnx_input, [384, 384])
...
file = Path("test/assets/results/classification/efficientnet_v2_s.json")
