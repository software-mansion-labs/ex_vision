defmodule ExVision.Classification.EfficientNet_V2_S_Test do
  @moduledoc false
  use ExVision.Model.Case, module: ExVision.Classification.EfficientNet_V2_S
  use ExVision.TestUtils

  @expected_result "test/assets/results/classification/efficientnet_v2_s.json"
                   |> File.read!()
                   |> Jason.decode!()
