defmodule ExVision.Classification.EfficientNet_V2_M_Test do
  @moduledoc false
  use ExVision.Model.Case, module: ExVision.Classification.EfficientNet_V2_M
  use ExVision.TestUtils

  @expected_result "test/assets/results/classification/efficientnet_v2_m.json"
                   |> File.read!()
                   |> Jason.decode!()
